...
class TaxonomyFormat(model.TextFileFormat):
    ...
    This format has been superseded by explicit taxonomy file formats with and
    without headers, `TSVTaxonomyFormat` and `HeaderlessTSVTaxonomyFormat`,
    respectively.
        ...
        with self.open() as fh:
            ...
            while data_lines < 10:
                ...
                if header is None:
                    ...
                    # TODO: Is this check necessary, or better in transformers?
